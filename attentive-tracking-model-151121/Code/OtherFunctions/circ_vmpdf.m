function [p alpha] = circ_vmpdf(alpha, thetahat, kappa,C)
...
% HK avoid INF --> NaN
% see http://www.mathworks.com/matlabcentral/newsreader/view_thread/237503
% % evaluate pdf

% C = 1/(2*pi*besseli(0,kappa,1));
p = C * exp(kappa*cos(alpha-thetahat) -abs(real(kappa)));
